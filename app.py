...
with model_testing:  
    ...
    bucket = storage_client.bucket('bk-rec-model2') # change the bucket name
    blob = bucket.blob('bookrec_matrix.pkl')
    matrix_file = tempfile.gettempdir() + '/bookrec_matrix.pkl'
